...
editBtn.onmouseenter = () => editBtn.style.transform = "rotate(90deg) scale(1.2)";
editBtn.onmouseleave = () => editBtn.style.transform = "rotate(0) scale(1)";
...
editBtn.addEventListener('click', function() {
    ...
    input.value = li.textContent; // existing text as default value
    ...
    deltBtn.style.marginLeft = "10px";
    deltBtn.style.cursor = "pointer";
    deltBtn.style.background = "red";
    deltBtn.style.color = "white";
    deltBtn.style.border = "none";
    deltBtn.style.borderRadius = "5px";

    // Clear li and append input + save button + delete button
    li.innerHTML = "";
    ...
    saveBtn.addEventListener('click', function() {
        li.textContent = input.value; // update li text with input value
    });
